...
def find_cam_name_in_promt():
    ...
    promt_to_get_cam_name_name = 'пожалуйста дай  название маркетинг кампании до 50 символов по следующему описанию '+'"'+ content + '"'+" в названии расскажи что мы предлагаем и какому сегменту."
