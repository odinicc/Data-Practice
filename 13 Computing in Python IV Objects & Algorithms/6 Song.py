...
class Song:
    ...
    def get_song_string(self):
        return '"' +str(self.name) + '"'+" - "+ str(self.artist.name) +' ('+str(self.year) +')'
...
#   artist.name = "Taylor Swift"
#   artist.label = "Big Machine Records, LLC"
song_2 = Song("All Too Well","Red",2012,Artist("Taylor Swift" ,"Big Machine Records, LLC" ) )
